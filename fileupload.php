...
{ 
    ...
    $targetDir = "fileuploadofpatient/";  //folder name
    $allowTypes = array('jpg','png','jpeg','gif','html','pdf'); 
    $patientid=$_POST['patientid'];
    $patientname=$_POST['patientname'];
    $date=$_POST['date'];
    $time=$_POST['time'];
    $fileuploadtimedate=$date.$time;
    ...
    {  
            ...
            { 
                ...
                $insert ="INSERT INTO fileupload (patientid,patientname,filenamepath,dates,time,fileuploadunique) VALUES ('$patientid','$patientname','$fileName','$date','$time','$fileuploadtimedate')";
